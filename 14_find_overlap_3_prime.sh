...
awk '{if($6=="+") print $1,($3-50),($3+50),$4,$5,$6; else print $1,($2-50),($2+50),$4,$5,$6}' $BED/transformedBed.bed  | tr ' ' '\t' > $BED/window3prime.bed
awk '{if($3<0 || $2<0) print $1,0,$3,$4,$5,$6; else print $1,$2,$3,$4,$5,$6}' $BED/window3prime.bed  | tr ' ' '\t' > $BED/window3prime2.bed
...
<<<<<<< HEAD:14_find_overlap_3_prime.sh
bedtools intersect -wa -s -a $BED/window3prime2.bed -b $BED/polyArefactor.bed > $BED/overlap3primeA.bed 
=======
bedtools intersect -wa -s -a $BED/window3prime2.bed -b $BED/polyArefactor.bed > $BED/overlap3primeA.bed
>>>>>>> d8ddbb1f929424825031952f38abb562c7736dda:16_find_overlap_3_prime.sh
