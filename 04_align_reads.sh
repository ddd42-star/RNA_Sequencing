...
#SBATCH --output=/data/users/dbassi/rnaseq_course/logFiles/04_align_reads_%j.o
...
mkdir -p /data/users/dbassi/rnaseq_course/mapped_reads
...
hisat2 -p $THREADS -x $INDEX/GRCh38 -1 $READS/P3_L3_R1_001_fjv6hlbFgCST.fastq -2 $READS/P3_L3_R2_001_xo7RBLLYYqeu.fastq -S $MAP/P3_L3.sam