...
kallisto index -i $EXPRESSION/all_kallisto_index --threads $THREADS $EXPRESSION/all_transcriptome.fa


#quantification algorithm
kallisto quant -i $EXPRESSION/all_kallisto_index -o $EXPRESSION --rf-stranded --threads $THREADS $FASTQ/*.fastq