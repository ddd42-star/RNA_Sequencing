...
<<<<<<< HEAD:13_find_overlap_5_prime.sh
awk '{if($3<0 || $2<0) print $1,0,$3,$4,$5,$6; else print $1,$2,$3,$4,$5,$6}' $BED/window5prime.bed  | tr ' ' '\t' > $BED/window5prime2.bed
=======
awk '{if($3<0 || $2<0) print $1,0,0,$4,$5,$6; else print $1,$2,$3,$4,$5,$6}' $BED/window5prime.bed  | tr ' ' '\t' > $BED/window5prime2.bed
>>>>>>> d8ddbb1f929424825031952f38abb562c7736dda:15_find_overlap_5_prime.sh
