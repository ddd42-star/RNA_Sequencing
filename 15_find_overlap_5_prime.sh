...
bedtools intersect -wa -s -a $BED/window5prime.bed -b $BED/refTSS_v4.1_human_coordinate.hg38.bed > $BED/overlap5primeForward.bed
# Bedtools intersect for 5' ends reverse strands(-)
bedtools intersect -wa -S -a $BED/window5prime.bed -b $BED/refTSS_v4.1_human_coordinate.hg38.bed > $BED/overlap5primeReverse.bed